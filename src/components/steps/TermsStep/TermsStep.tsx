...
import "../../../styles/components/terms-step.css";

export function TermsStep() {
    return (
        <section className="terms-step">
            <h3 className="terms-step__title fz-20">Lorem Ipsum is not simply</h3>

            <div className="terms-step__content --color-text">
                <p className="fz-16">
                    It is a long established fact that a reader will be distracted by the readable content of a page when looking at its
                    layout. The point of <span className="color-link fw-600 td-underline">using Lorem Ipsum</span> is that it has a more-or-less normal distribution
                ...
                <p className="fz-16">
                    ...
                    Lorem Ipsum which looks reasonable. The <span className="color-link fw-600 td-underline">generated Lorem Ipsum</span> is therefore always free from repetition, injected humour, or
            ...
            <div className="terms-step__checks fz-16">
                <CheckboxField label="Autorizo el tratamiento de mis datos personales" />
                <CheckboxField label="Autorizo el tratamiento de mis datos personales" />
            </div>
        </section>
    );
